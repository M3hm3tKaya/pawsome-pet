...
export default function IletisimPage() {
  ...
  const inputClass =
    "w-full px-4 py-3 min-h-[44px] rounded-2xl border-2 border-dark-brown/10 bg-warm-white font-body text-dark-brown text-base placeholder:text-dark-brown/40 focus:outline-none focus:border-orange focus:ring-2 focus:ring-orange/20 transition-all";
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-2">
              <AnimatedSection>
                <div className="bg-warm-white rounded-2xl sm:rounded-[24px] p-5 sm:p-8 md:p-10">
            ...
            <div>
              <AnimatedSection delay={0.2}>
                <div className="space-y-6">
                  <div className="bg-orange-light rounded-2xl p-5 sm:p-6">
                    <div className="w-11 h-11 sm:w-12 sm:h-12 bg-white rounded-xl flex items-center justify-center mb-3 sm:mb-4 shadow-sm">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                      </svg>
                    </div>
                    <h3 className="font-heading font-bold text-dark-brown mb-1 text-sm sm:text-base">Adres</h3>
                    <p className="text-dark-brown/60 font-body text-xs sm:text-sm">
                      Çekmeköy Merkez Mah. Hayvan Severler Cad. No: 42
                      <br />Çekmeköy / İstanbul
                    </p>
                  </div>

                  <div className="bg-teal-light rounded-2xl p-5 sm:p-6">
                    <div className="w-11 h-11 sm:w-12 sm:h-12 bg-white rounded-xl flex items-center justify-center mb-3 sm:mb-4 shadow-sm">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                    </div>
                    <h3 className="font-heading font-bold text-dark-brown mb-1 text-sm sm:text-base">Telefon</h3>
                    <p className="text-dark-brown/60 font-body text-xs sm:text-sm">
                      0216 555 00 00
                  ...
                  <div className="bg-pink-light rounded-2xl p-5 sm:p-6">
                    <div className="w-11 h-11 sm:w-12 sm:h-12 bg-white rounded-xl flex items-center justify-center mb-3 sm:mb-4 shadow-sm">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-pink" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <h3 className="font-heading font-bold text-dark-brown mb-1 text-sm sm:text-base">Çalışma Saatleri</h3>
                    <p className="text-dark-brown/60 font-body text-xs sm:text-sm">
                  ...
                  <div className="bg-blue-light rounded-2xl p-5 sm:p-6">
                    <div className="w-11 h-11 sm:w-12 sm:h-12 bg-white rounded-xl flex items-center justify-center mb-3 sm:mb-4 shadow-sm">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <h3 className="font-heading font-bold text-dark-brown mb-1 text-sm sm:text-base">E-posta</h3>
                    <p className="text-dark-brown/60 font-body text-xs sm:text-sm">
                      info@pawsomepet.com
      ...
      <section className="bg-warm-white py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="aspect-[16/9] sm:aspect-[21/9] bg-gradient-to-br from-teal-light to-blue-light rounded-2xl sm:rounded-[24px] flex items-center justify-center overflow-hidden">
